...
export default {
    ...
    computed: {
        ...
        isFavorite() {
            let favorites = (this.$cookie.get('favorites') || []);
    ...
    methods: {
        ...
        toggleFavorite() {
            // this.$cookie.delete('favorite');
            let favorites = this.$cookie.get('favorites') || [];
            console.log(this.$cookie.get('favorites'))
            // if ( favorites.find(el=>el.url===this.product.url) ) {
            ...
            this.$cookie.set('favorites',favorites);
        }
    }
};
</script> 