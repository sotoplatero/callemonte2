¸<template>
  <div >
      ...
      <div class="mb-5">
        <p class="lead text-justify"><b>Callemonte.com</b> <i>(anteriormente unclic.pro)</i> es un buscador de anuncios de productos en sitios de Cuba: <a href="https://www.revolico.com" rel="nofollow" target="_blank">Revolico</a>, <a href="https://www.bachecubano.com"  rel="nofollow" target="_blank">Bachecubano</a>, <a href="https://1cuc.com" rel="nofollow" target="_blank">1cuc</a>, <a href="https://www.timbirichi.com" rel="nofollow" target="_blank">Timbirichi</a> y <a href="https://porlalivre.com" rel="nofollow" target="_blank">Porlalivre</a>,  <a href="https://merolico.app" rel="nofollow" target="_blank">Merolico</a>, <a href="https://hogarencuba.com" rel="nofollow" target="_blank">Hogarencuba</a> y seguiremos incrementando la lista. Si tienes algún sitio que agregar <nuxt-link to="/contact">contáctanos</nuxt-link>.</p>
      ...
      <div class="card-deck mb-4">
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
          <h3 class="card-title">Cuida tus Datos</h3>
      ...
      <div class="card-deck mb-4">
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h3 class="card-title">Limpia el texto</h3>
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h3 class="card-title">Anuncios con precio</h3>
      ...
      <div class="card-deck mb-4">
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h3 class="card-title">Sin Duplicados</h3>
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h3 class="card-title">Sin publicidad</h3>
      ...
      <p class="lead my-5">
        Callemonte está en desarrollo y puede que tenga algún problema, no dudes en <a href="/contact">escribirnos</a> para mejorarlo.
      </p>
